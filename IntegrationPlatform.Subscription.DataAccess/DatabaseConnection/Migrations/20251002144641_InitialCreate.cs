        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    InterfaceSubscriptionId = table.Column<int>(type: "integer", nullable: false),
                    InterfacePublicationId = table.Column<int>(type: "integer", nullable: false),
                    IntegrationPattern = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrchestrationConfig_DataInterfaces_InterfaceSubscriptionId",
                        column: x => x.InterfaceSubscriptionId,
                        principalSchema: "subscription",
                        principalTable: "DataInterfaces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrchestrationConfig_InterfaceSubscriptionId",
                schema: "subscription",
                table: "OrchestrationConfig",
                column: "InterfaceSubscriptionId",
                unique: true);
        }
